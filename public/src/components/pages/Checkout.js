...
const Checkout = (props) => {
  ...
  const checkout = async (event) => {
    ...
    let uniqpref =
      customer.customerInfo.fullName[0] + "" + customer.customerInfo.address[2];
    ...
    let updatedCustomer = {
      ...
      total: total,
      orderNote:
        customer.customerInfo.orderNote === undefined
          ? ""
          : customer.customerInfo.orderNote,
  ...
  return (
    <div>
      <Helmet>
        <title>Checkout | Mobicenter | Kenyas Number One Mobile Shop</title>
      </Helmet>
              ...
              <div className="col-md-8">
                <div className="personal-information">
                  ...
                  <select required id="country" onChange={handleChange}>
                    <option value="Choose country" selected>
                      Choose Country
                    </option>
              ...
              <div className="col-md-4">
                <div className="checkout-details">
                  ...
                  <ul>
                    ...
                    <li>
                      <h6>{"D" + new Intl.NumberFormat().format(total)}</h6>
                    </li>
                  </ul>
                  <hr />
                  <ul>

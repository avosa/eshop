        ...
        <div className="product-description">
          <h6>
            <Link
              to={value.slug}
              onClick={() => {
                getProductByID(products, value.id);
              }}
            >
              {value.name} -{" "}
              {"D" + new Intl.NumberFormat().format(value.sale_price)}
            </Link>
          </h6>
        </div>
      </div>
...
const Home = (props) => {
  ...
  const getTrendingProducts = async () => {
    ...
    if (process.env.NODE_ENV === "development") {
      url =
        process.env.REACT_APP_DEVELOPMENT_API_URL + "/api/v1/trending-products";
    } else {
      url =
        process.env.REACT_APP_PRODUCTION_API_URL + "/api/v1/trending-products";
    }
    let response = await fetch(url);
    let data = await response.json();
  ...
  return (
    <div>
      <Helmet>
        <title>Home | Mobicenter | Kenyas Number One Mobile Shop</title>
      </Helmet>
      <div className="home">
        <div className="home-inner">
            ...
            <div className="row carousel-row">
                  ...
                  <div className="carousel-inner text-center">
                    <div className="carousel-item active">
                      <img
                        ...
                        src={require("../../media/images/banner1.jpg")}
                        alt={"First Slide"}
                      />
                    ...
                    <div className="carousel-item">
                      <img
                        ...
                        src={require("../../media/images/banner2.jpg")}
                        alt="Second slide"
                      />
                    ...
                    <div className="carousel-item">
                      <img
                        className="d-block w-100"
                        src={require("../../media/images/banner3.jpg")}
                        alt="Third slide"
                      />
                      <div className="text-content">
                        <h1>Classic Phone Accessories</h1>
                        <a href="shop" className="shop-btn">
                          SHOP NOW
                        </a>
                      </div>
              ...
              <div className="col-md-3 sidebar-carousel">
                ...
                <div className="sidebar-img">
                  <img
                    src={require("../../media/images/woman.jpg")}
                    style={{ maxWidth: "100%", maxHeight: "100%" }}
                  />
                </div>
                <div className="sidebar-img">
                  <img
                    src={require("../../media/images/shoe.jpg")}
                    style={{ maxWidth: "100%", maxHeight: "100%" }}
                  />
                </div>
              </div>
          ...
          <div className="category">
            <div className="category-title">
              <h4>
                Trending <img src={require("../../media/icons/trending.png")} />
              </h4>
            </div>
            {trending.length > 1 ? (
              <>
          ...
          <div className="category">
            <div className="category-title">
              <h4>
                Mobile Phones{" "}
                <img src={require("../../media/icons/mobile.png")} />
              </h4>
            </div>

  ...
  return (
    <tr>
      ...
      <td>
        ...
        <sub>
          {item.sale_price} x {item.qty === 1 ? "1 item" : item.qty + " items"}
        </sub>
      </td>
      <td>
        <h6 className="delete">
          <Link to="/cart" onClick={() => deleteItem(item, cartItems)}>
...
const Cart = (props) => {
  ...
  return (
    <div>
      <Helmet>
        <title>Cart | Mobicenter | Kenyas Number One Mobile Shop</title>
      </Helmet>
          ...
          <div className="cart-empty">
            <div className="cart-empty-inner">
              <div className="empty-cart-content">
                <img
                  src={require("../../media/svg/empty-cart.svg")}
                  ...
                  <div className="cart-details">
                    <ul>
                      ...
                      <li>
                        <h6>
                          {props.itemInCart > 1
                            ? props.itemInCart + " items"
                            : props.itemInCart + " item"}
                        </h6>
                      </li>
                    </ul>
                    <hr />

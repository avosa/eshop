...
const ProductSingle = (props) => {
  ...
  return (
    <div>
      <Helmet title={product.name + " | Mobicenter"}>
        <title> Mobicenter </title>
      </Helmet>
        ...
        <div className="single-product-description">
          <div className="row">
            <div className="col-md-12" style={{ padding: "0px 30px" }}>
              ...
              <h3>Return Policy</h3>
              <p>
                <i className="fa fa-repeat"></i> 7 Days Return Guarantee
              </p>
              <h3>Delivery</h3>
              <p>
                <i className="fa fa-truck"></i> 2 - 9 Hours
              </p>
            </div>
          </div>
        </div>
                        ...
                        <div className="product similar-item">
                          <div className="product-img">
                            <a
                              href={value.slug}
                              onClick={() =>
                                props.getProductByID(upsell, value.id)
                              }
                            >
                              <img
...
export default connect(mapStateToProps, { addToCart, getProductByID })(
  ProductSingle
);

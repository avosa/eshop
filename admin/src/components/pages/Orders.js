            ...
            return (
              <>
                {value.total !== undefined ? (
                  <tr>
                    <td>
                      <Link to={"/order/" + value.order_number}>
                        {value.order_number}
                      </Link>
                    </td>
...
const Orders = (props) => {
  ...
  return (
    <div>
      <Navbar />
      <Helmet>
        <title>Orders | Mobicenter Dashboard</title>
      </Helmet>
                  ...
                  <>
                    <nav aria-label="Products Navigation">
                      <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item">
                          <a class="page-link" href="/orders/1">
                            1
                          </a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="/orders/2">
                            2
                          </a>
                        </li>
                        <li
                  ...
                  <>
                    <nav aria-label="Products Navigation">
                      <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item">
                          <a class="page-link" href="/orders/3">
                            3
                          </a>
                        </li>
                        <li
                  ...
                  <>
                    <nav aria-label="Products Navigation">
                      <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item">
                          <a class="page-link" href="/orders/4">
                            4
                          </a>
                        </li>
                        <li
                ...
                {Number(pagination.last_page) > 4 ? (
                  <nav aria-label="Products Navigation">
                    <ul class="pagination justify-content-center">
                      ...
                      <li class="page-item">
                        <a className="page-link" href="/orders">
                          1
                        </a>
                      </li>
                      {Number(page.page) < 4 ? (
                        <>
                          <li class="page-item">
                            <a className="page-link" href="/orders/2">
                              2
                            </a>
                          </li>
                          <li class="page-item">
                            <a className="page-link" href="/orders/3">
                              3
                            </a>
                          </li>
                          <li class="page-item">
                            <a className="page-link" href="/orders/4">
                              4
                            </a>
                          </li>
                      ...
                      {Number(pagination.last_page) - Number(page.page) >= 3 ? (
                        <li class="page-item">
                          <a
                            class="page-link"
                            href={"/orders/" + Number(pagination.last_page)}
                          >
                            {" "}

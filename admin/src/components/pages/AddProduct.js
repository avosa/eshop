...
const AddProduct = (props) => {
  ...
  return (
    <div>
      <Navbar />
      <Helmet title="Add Product | Mobicenter | Kenyas Number One Mobile Shop" />
        ...
        <div className="add-product-inner">
          <div className="row">
            ...
            <div className="col-md-8 right">
              <h2>
                Product Information -{" "}
                <a href="/add-product" className="new">
                  New
                </a>
              </h2>
                  ...
                  <div className="col-md-5">
                    <div className="form-group">
                      ...
                      <div className="row">
                        <ImageList
                          images={
                            product.images ? chunk(4, product.images) : [[]]
                          }
                        />
                      </div>
                      <a

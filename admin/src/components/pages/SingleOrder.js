    ...
    <>
      {orderID !== 0 && loading.loading === false ? (
        <div>
          <Navbar />
          <Helmet>
            <title>Order Summary | Mobicenter Dashboard</title>
          </Helmet>
              ...
              <div className="row">
                ...
                <div className="col-md-8 right">
                  <ul>
                    ...
                    <li>
                      <span className="order-amount-summary">
                  ...
                  <h6>
                    {"#" + order.orderNumber}{" "}
                    <span>
                      <FaClock /> Updated on {order.updatedAt}{" "}
                    </span>
                  </h6>
                  <h3>Overview</h3>
                  <div className="row">

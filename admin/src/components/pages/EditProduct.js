...
const EditProduct = (props) => {
  ...
  const getCategories = async () => {
    ...
    if (process.env.NODE_ENV === "development") {
      url =
        process.env.REACT_APP_DEVELOPMENT_API_URL +
        "/api/v1/product/categories?token=" +
        props.token;
    } else {
      url =
        process.env.REACT_APP_PRODUCTION_API_URL +
    ...
    openUploadWidget(uploadOptions, (error, photos) => {
      if (!error) {
        ...
        if (photos.event === "queues-end" && edit.images) {
          ...
          setEdit(
            Object.assign({}, edit, { images: updatedImages, imageAdded: true })
          );
        ...
        <div className="add-product-inner">
          <div className="row">
            ...
            <div className="col-md-8 right">
              <h2>
                Product Information{" "}
                <Link class="edit-delete" to="" onClick={deleteProduct}>
                  {" "}
                    ...
                    <div className="form-group">
                      ...
                      <div className="row">
                        <ImageList
                          images={
                            edit.images
                              ? chunk(4, Object.values(edit.images))
                              : [[]]
                          }
                        />
                      </div>
                      ...
                      >
                        Click to add images <i className="fa fa-plus"></i>
                      </a>
                    </div>
                  </div>
                  <div className="col-md-2">

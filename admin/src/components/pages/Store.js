...
const Store = (props) => {
  ...
  const handleChange = (event) => {
    setSearch(
      Object.assign({}, search, { [event.target.id]: event.target.value })
    );
    console.log(search);
  };
  ...
  return (
    <div>
      <Navbar />
      <Helmet>
        <title>Store | MobicenterDashboard</title>
      </Helmet>
                ...
                <>
                  <nav aria-label="Products Navigation">
                    <ul class="pagination justify-content-center">
                      ...
                      <li class="page-item">
                        <a class="page-link" href="/store/1">
                          1
                        </a>
                      </li>
                      <li class="page-item">
                        <a class="page-link" href="/store/2">
                          2
                        </a>
                      </li>
                      <li
                  ...
                  <ul class="pagination justify-content-center">
                    ...
                    {Number(page.page) < 4 ? (
                      <>
                        ...
                        <li class="page-item">
                          <a class="page-link" href="/store/3">
                            3
                          </a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="/store/4">
                            4
                          </a>
                        </li>
                      </>
                      ...
                      <>
                        ...
                        <li class="page-item">
                          ...
                          >
                            {Number(pagination.last_page) - Number(page.page) <=
                            3
                              ? Number(pagination.last_page) - 2
                              : Number(page.page)}
                          </a>
                    ...
                    Number(pagination.last_page) - Number(page.page) > 4 ? (
                      <li class="page-item">
                        <a class="page-link" href="#">
                          ...
                        </a>
                    ...
                    {Number(pagination.last_page) - Number(page.page) > 3 ? (
                      <li class="page-item">
                        <a
                          class="page-link"
                          href={"/store/" + Number(pagination.last_page)}
                        >
                          {" "}
